...
exercise_data = [
  { title: "5 Air Push-Ups", description: "Basic push-ups for upper body strength.", exercise_xp: 10, is_bonus: false, image_url: "animationsFA/Push_ups.gif" },
  { title: "6 Kicks", description: "Core exercise focusing on the abdominal muscles.", exercise_xp: 15, is_bonus: false, image_url: "animationsFA/Sit_ups.gif" },
  { title: "6 Alt Lunges", description: "Great for leg muscle and strength.", exercise_xp: 25, is_bonus: false, image_url: "animationsFA/Alt_Leg_Lunge.gif" },
  { title: "6 Raise Basket", description: "Full body strength and aerobic exercise.", exercise_xp: 20, is_bonus: false, image_url: "animationsFA/HalfBurpees.gif" },
  { title: "5 Go Toilet", description: "Excellent for building lower body strength.", exercise_xp: 15, is_bonus: false, image_url: "animationsFA/Squats.gif" },
  ...
  { title: "6 Stand Ups", description: "Works on your back and arm muscles.", exercise_xp: 35, is_bonus: true, image_url: "animationsFA/High_knee.gif" },
